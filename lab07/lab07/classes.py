...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        300
        """
        # Store opponent card's attack and defense
        original_attack = other_card.attack
        original_defense = other_card.defense

        # Swap attack and defense
        other_card.attack = original_defense
        other_card.defense = original_attack
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        # Remove cards from opponent deck that match other_card
